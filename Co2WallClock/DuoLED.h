...
class DuoLED {
  ...
  public:
    ...
    void green() {
      ...
      analogWrite(_pinGreen, _brightness);
    ...
    void setBrightness(DayPeriod period) {
      switch (period) {
        case (DayPeriod::NIGHT): _brightness = 254; break;
        case (DayPeriod::EVENING): _brightness = 254; break;
        case (DayPeriod::DAY): _brightness = 254;
      }
    }
};
